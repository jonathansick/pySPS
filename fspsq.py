...
FILTER_LIST = [(1,'V','Johnson V (from Bessell 1990 via M. Blanton)  - this defines V=0 for the Vega system'),
        ...
        (18,"WFC ACS F850LP","WFC ACS F850LP  (http://acs.pha.jhu.edu/instrument/photometry/)"),
        ...
        (51,"Steidel I","Steidel I  (via A. Shapley; see Steidel et al. 2003)"),
